...
def create_builder():
    # To jest skrypt, który wygeneruje Twój setup_project.py
    # Został pozbawiony zbędnych opisów dla maksymalnej kompresji.
    
    setup_content = r'''import os, sys, base64, zlib
...
'''
    ...
    output_file = "setup_project.py"
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(setup_content)
    
    print(f"✅ Wygenerowano plik instalacyjny: {output_file}")
    print("Teraz uruchom: python setup_project.py")
